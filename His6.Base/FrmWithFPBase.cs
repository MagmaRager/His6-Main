...
namespace His6.Base
{
    ...
    /// </summary>
    public partial class FrmWithFPBase : FrmBase, IFunctionPoint
    {
        public FrmWithFPBase()
        {
            InitializeComponent();
        }
        ...
        ///  功能点信息数据
        /// </summary>
        private List<DataFunctionPoint> _FunctionPointList = new List<DataFunctionPoint>();
        ...
        /// </summary>
        [Browsable(false)]
        public List<DataFunctionPoint> FunctionPointList
        {
