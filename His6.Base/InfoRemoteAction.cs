...
namespace His6.Base
{
    ...
    public class InfoRemoteAction : IDisposable
    {
        ...
        public InfoRemoteAction(List<String> codes, OnCallbackInfo callback)
        {
            infoCodeList = codes;
            ...
            {
                InfoRemoteHelper.RegisterInfo(this, infoCodeList);
            }
        }
